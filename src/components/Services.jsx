      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight relative">
            Securing & Crafting Digital Excellence
            {/* Hand-drawn arrow */}
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            Delivering robust security insights, modern full-stack web solutions, AI automation, and privacy tools tailored for modern tech needs.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            ...
            text="Conducting basic security assessments, vulnerability analysis, network scanning, and exploring secure system practices."
          ...
          <TagCard 
            ...
            text="Building responsive, modern, and user-friendly websites and web applications using HTML, CSS, JavaScript, React, and related technologies."
          ...
          <TagCard 
            ...
            text="Developing AI-integrated tools and applications that automate tasks, analyze information, and provide intelligent insights."
          ...
          <TagCard 
            number="04"
            title="🛡️ Privacy & Security Tools"
            text="Creating security and privacy-focused applications such as metadata analysis, metadata cleaning, and honeypot-based monitoring systems."
